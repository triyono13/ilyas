...
@section('title') Data Gudang @endsection
                            ...
                            @foreach ($gudang as $result => $hasil)
                                ...
                                <td style="text-align: center;">
                                    <form action="{{route('gudang.destroy', $hasil->id)}}" method="POST">
                                        @csrf
                                        @method('delete')
                                        <a href="#" onclick="edit_kategori('{{route('gudang.edit', $hasil->id)}}')" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Edit Transaksi" class="btn btn-primary btn-flat btn-sm">
